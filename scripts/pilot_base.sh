...
cd "$PROJ/lerobot" && .venv/bin/python "$SCRIPTS/summarize_datasets.py" pilot_D_base_smoke pilot_D_base_object_std pilot_D_base_goal_std 2>/dev/null | tee -a "$MASTER"
